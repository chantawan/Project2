      ...
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <div class="d-flex justify-content-center pull-right">
            ...
            <a href="document_storage.php">
            <button class="btn btn-warning pull-right"><i class="far fa-file-image"></i>  ดูไฟล์</button></a>
        </div>
      </div>
      <hr>
      <!-- Heading -->
        ...
        <form action="fileprocess.php" method="post" enctype="multipart/form-data" >
          <div class="col-md-11">
              <div class="md-form mb-0">
                ...
                <input type="text" value="<?php echo ucwords(htmlentities($emp_firstname)); ?>" class="form-control" readonly="">
              </div>
            </div>
           <label for="subject" class="">อัพโหลดไฟล์</label>
          <input type="file" name="myfile"> <br>
          <button  type="submit" class="btn btn-info btn-rounded btn-block my-4 waves-effect z-depth-0"  name="save" type="submit">อัพโหลด</button>
          <footer style="font-size: 11px"><b>ชนิดไฟล์:</b><font color="red"><i>.docx .doc .pptx .ppt .xlsx .xls .pdf .odt</i></font></footer>
        </form>
      </div>
