   ...
   $user = $_POST['email'];
    ...
    if (!in_array($extension, ['pdf'])) {
        echo '<script type = "text/javascript">
                    ...
                    window.location = "add_file_user.php";
                </script>
';
  ...
  $query=mysqli_query($conn,"SELECT * FROM `upload_files` WHERE `FILES_NAME` = '$filename'")or die(mysqli_error($conn));
            ...
            if ($counter == 1) 
              { 
                ...
                <script type = "text/javascript">
                    ...
                    window.location = "document_storage.php";
                </script>
...
//            $user = $_SESSION['email_address'];
        ...
        if (move_uploaded_file($file, $destination)) {
            $sql = "INSERT INTO upload_files (FILES_NAME, size, download, timers, admin_status, email) VALUES ('$filename', $size, 0, '$time', 'Employee', '$user')";
