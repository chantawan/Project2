...
?>
            ...
            <td>
            <button class="btn btn-sm btn-success"style="width:10%; margin-left:10%" onclick="Onsent2(<?= $row['Doc_id']; ?>)" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal5">รับทราบ/ดำเนินการต่อ</button>
